            ...
            <div class="">
                <div class="space-y-6">
                    ...
                    <div class="mx-auto w-[100%]">
                        ...
                        <div class="mt-2">
                            <input id="judul" name="judul" type="text" autocomplete="off" placeholder="Judul" value="<?php echo $artikel['judul'] ?>" required class="block w-[100%]  rounded-md border-0 py-1.5 text-gray-900 white shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                    </div>
                    <div class="mx-auto w-[100%]">
                        <div class="">
                            ...
                            <div class="grid grid-cols-12 gap-10">
                                ...
                                <div class="h-96 flex col-span-8 w-full place-items-center relative bg-gray-800 rounded-lg">
                                    ...
                                    <img src="/<?php echo $artikel['img'] ?>" id="img" class="h-96 object-cover align-items-center mx-auto" onload="readURL()">
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="mx-auto w-[100%]  ">
                        ...
                        <div class="mt-2">
                            <textarea id="isi" name="isi" rows="16" cols="50" type="text" placeholder="Isi Artikel" autocomplete="off" class=" "><?php echo $artikel['content'] ?></textarea>
                        </div>
                    </div>
                    <div class="flex gap-10">
                        <div class="w-1/2">
                            <label for="tag" class="block text-sm font-medium leading-6 ">Tag</label>
                            <input type="text" value="<?php echo $artikel['tag'] ?>" placeholder="Maksimal 2 tag, pisahkan dengan '#' (#tag1 #tag2)" id="tag" name="tag" class="mt-2 block w-[100%] rounded-md border-0 py-1.5 text-gray-900 white shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                        </div>
                        <div class="w-1/2">
