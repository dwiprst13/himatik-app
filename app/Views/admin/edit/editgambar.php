    ...
    <div class="ml-64 h-screen">
        ...
        <div class=" px-3 py-4 flex justify-between">
            <div class="w-full flex justify-between">
                ...
                <form action="/himatikadmin/artikel/gambar/deletegambar/<?php echo $gambar['id_gambar'] ?>">
        ...
        <form class="w-[90%] flex flex-col mx-auto" action="/himatikadmin/artikel/gambar/editgambar" method="POST" enctype="multipart/form-data" autocomplete="off">
            <input id="" name="id_gambar" type="hidden" value="<?php echo $gambar['id_gambar'] ?>">
            <div class="my-12">
                <div class="grid grid-cols-12 gap-5">
                    <div class="col-span-5 space-y-5">
                        <div class="mx-auto w-[100%]">
                            <label for="new_nama" class="block text-sm font-medium leading-6 ">Nama</label>
                            <div class="mt-2">
                                <input id="new_nama" name="new_nama" type="text" value="<?php echo $gambar['nama'] ?>" placeholder="Beri Nama Gambar" autocomplete="off" required class="block w-[100%] rounded-md border-0 py-1.5 text-gray-900 white shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        <div class="mx-auto w-[100%]">
                    ...
                    <div class="col-span-7">
                        <div class="w-[100%] place-items-center mx-auto bg-gray-300 h-72 rounded-lg">
                            <img src="/<?= isset($gambar['img']) ? $gambar['img'] : ''; ?>" id="img" class="h-72 object-cover align-items-center mx-auto">
                        </div>
                    </div>
                </div>
