...
<body>
    <div class="ml-64 h-screen">
        ...
        <form class="w-[90%] flex flex-col mx-auto" action="/himatikadmin/proker/tambahproker" method="POST" enctype="multipart/form-data" autocomplete="off">
            <div class="my-12">
                <div class="grid grid-cols-12 gap-5">
                    <div class="col-span-5 space-y-5">
                        ...
                        <div class="mx-auto w-[100%]">
                            ...
                            <div class="mt-2">
                                <input id="date" name="date" type="text" autocomplete="off" placeholder="Tanggal pelaksanaan" required class="block w-[100%]  rounded-md border-0 py-1.5 text-gray-900 white shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
                        <div>
