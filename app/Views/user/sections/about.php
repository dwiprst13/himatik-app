...
<section class="bg-gray-900">
    <div class="w-[95%] mx-auto md:w-[90%] bg-white rounded-2xl p-3 md:p-5 shadow-lg">
        ...
        <div class="my-10 space-y-5">
            <div class="bg-blue-700 rounded-full text-white w-fit px-3 md:p-1 px-5 flex items-center shadow-xl">
        ...
        <div class="my-10 space-y-5">
            <div class="bg-blue-700 rounded-full text-white w-fit p-1 px-5 flex items-center shadow-xl">
